...
Book.create = (newBook, result) => {
 console.log(newBook);
 sql.query("INSERT INTO books (title, description, images)[newBook.title, newBook.description, newBook.images]"), (err,res) => {
     if (err) {
        console.log("error: ", err);
        result(err, null);
        return;
     ...
     console.log(res);
     console.log("buat buku: ", { 
         id: res.insertId, ...newBook
     });
